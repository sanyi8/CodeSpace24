<?php 
  ...
  if ( empty( $errors ) ) 
  {
    $q = "INSERT INTO items (item_name, item_desc, item_img, item_price) 
	VALUES ('$n','$d', '$img', '$p' )";
...
<br>
  ...
  <input type="number" id="item_price" required  name="item_price" min="0" step="0.01"  value="<?php if (isset($_POST['item_price'])) echo $_POST['item_price']; ?>"><br>
<br>
